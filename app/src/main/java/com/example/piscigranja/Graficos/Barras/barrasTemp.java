...
public class barrasTemp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barras_temp);
    ...
    private void getDataUser(){
        ...
        mDatabase.child("Usuarios").child(id).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                for(int i = 0 ; i<jsonArray.length() ; i++){
                                    ...
                                    xAxis1.add("");
                                    values = new BarEntry(Float.valueOf(temperatura),i);
                                    yValues.add(values);
                                    mDialog.dismiss();
                                ...
                                e.printStackTrace();
                                Toast.makeText(barrasTemp.this,"Error de conexión",Toast.LENGTH_LONG).show();
                                mDialog.dismiss();

                            }

                            BarDataSet barDataSet1 = new BarDataSet(yValues, "Temperatura");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                mDialog.dismiss();
                Toast.makeText(barrasTemp.this,"Error de base de datos",Toast.LENGTH_LONG).show();
