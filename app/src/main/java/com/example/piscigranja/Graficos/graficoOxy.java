...
import com.example.piscigranja.Graficos.Barras.barrasOxy;
...
public class graficoOxy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grafico_oxy);
        ...
        btnfloat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                startActivity(new Intent(graficoOxy.this, barrasOxy.class));
            }
        });
    ...
    private void getDataUser(){
        ...
        mDatabase.child("Usuarios").child(id).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                for(int i = 0 ; i<jsonArray.length() ; i++){
                                    ...
                                    String ph = data.getString("oxigeno");
                                    int ph_int = data.getInt("oxigeno");
                                ...
                                e.printStackTrace();
                                Toast.makeText(graficoOxy.this,"Error de conexión",Toast.LENGTH_LONG).show();
                                mDialog.dismiss();

                            }

                            LineDataSet set1 = new LineDataSet(x, "Oxigeno disuelto");
                            set1.setColor(Color.rgb(0, 130, 63));
                            set1.setLineWidth(1.5f);
                            set1.setCircleColor(Color.rgb(0, 130, 63));
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                mDialog.dismiss();
                Toast.makeText(graficoOxy.this,"Error de base de datos",Toast.LENGTH_LONG).show();
