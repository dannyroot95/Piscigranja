    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtYaTengo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(com.example.piscigranja.registro.this,authLogin.class));
                finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                if(!Snombres.isEmpty() && !Semail.isEmpty() && !Sclave.isEmpty()){
                    if(Sclave.length() >= 6){
                        ...
                        Toast.makeText(com.example.piscigranja.registro.this , "La contraseña debe tener más de 6 caracteres" ,Toast.LENGTH_SHORT).show();
                    }
                }
                else {
                    Toast.makeText(com.example.piscigranja.registro.this , "Debe llenar los campos" ,Toast.LENGTH_SHORT).show();
                }
        ...
        mAuth.createUserWithEmailAndPassword(Semail,Sclave).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    mDatabase.child("Usuarios").child(id).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task2) {
                            ...
                            if(task2.isSuccessful()){
                                ...
                                mDialog2.dismiss();
                                Toast.makeText(com.example.piscigranja.registro.this , "No se pudo crear los datos correctamente" ,Toast.LENGTH_SHORT).show();
                            }
                    ...
                    mDialog2.dismiss();
                    Toast.makeText(com.example.piscigranja.registro.this , "No se pudo registrar este usuario" ,Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
